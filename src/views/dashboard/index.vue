  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imgagerror="defaultImage" :src="staffPhoto">
          </div>
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            <el-button class="sideBtn" @click="workState">加班离职</el-button>
    ...
    <!-- 加班/离职弹出框 -->
    <el-dialog :visible="showWorkDialog" title="离职申请" @close="btnCancel">
      <el-form
        ref="ruleForm"
        :model="ruleForm"
        status-icon
...
export default {
  ...
  data() {
    return {
      ...
      showWorkDialog: false, // 加班离职弹出框的显示或隐藏
      ruleForm: { //  加班离职的数据
        exceptTime: '',
        reason: '',
  ...
  computed: {
    ...mapGetters([
      'name', 'staffPhoto', 'userId', 'username'
    ])
  },
  methods: {
    workState() {
    ...
    btnOK() {
      this.$refs.ruleForm.validate(async validate => {
        if (validate) {
          ...
          const data = { ...this.ruleForm, userId: newUserId, username: this.username }

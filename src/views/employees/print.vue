...
export default {
  ...
  methods: {
    async getPersonalDetail() {
      const qqq = await getPersonalDetail(this.userId)
      console.log(qqq)
    ...
    async getJobDetail() {
      ...
      const { data: jobData } = await getJobDetail(this.userId) // 获取个人基本信息
      this.formData = { ...data, ...jobData }
    }
  }
}
</script>
